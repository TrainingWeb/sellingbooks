                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mx-0">
                                                            <v-btn color="green accent-4 white--text" @click="addCart">
                                                                <i class="material-icons add-shopping mr-2 white--text" to="/card">add_shopping_cart</i>Thêm</v-btn>
                                                            <v-btn color="green accent-4 " @click="favorite">
                                                                <i class="material-icons favorite white--text" to="/favorite">favorite</i>
                                                            </v-btn>
                                                        </div>
